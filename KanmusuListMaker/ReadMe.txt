================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KanmusuListMaker プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KanmusuListMaker には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KanmusuListMaker アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

KanmusuListMaker.vcxproj
...
KanmusuListMaker.vcxproj.filters
...
KanmusuListMaker.h
   ...
   CKanmusuListMakerApp アプリケーション クラスを宣言します。

KanmusuListMaker.cpp
   これは、アプリケーション クラス CKanmusuListMakerApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KanmusuListMaker.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル KanmusuListMaker.rc に含まれていま
   す。

res\KanmusuListMaker.rc2
...
KanmusuListMakerDlg.h, KanmusuListMakerDlg.cpp - ダイアログ
   これらのファイルは CKanmusuListMakerDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KanmusuListMaker.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KanmusuListMaker.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
